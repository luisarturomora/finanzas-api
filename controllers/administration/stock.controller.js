...
var stock_model_1 = require("../../models/administration/stock.model");
...
var StockController = /** @class */ (function (_super) {
    ...
    function StockController() {
        var _this = this;
        var model = new stock_model_1.StockModel();
        _this = _super.call(this, model) || this;
        _this.document_name = enums_1.COLLECTION_NAME_ENUM.stock;
        return _this;
    }
    StockController.prototype.transfer = function (req, res) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.model['transfer'](object)];
                    case 1:
                        _a.sent();
                        res.json({
                            result: true,
