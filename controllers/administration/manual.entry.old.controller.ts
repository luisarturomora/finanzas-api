...
import { ManualEntryOldModel } from '../../models/administration/manual.entry.old.model';
import { mongo } from 'mongoose';

export class ManualEntryOldController extends BaseController{
    model: ManualEntryOldModel;
    constructor(){
        let model = new ManualEntryOldModel();
        super(model)
        this.model = model;
        this.document_name = COLLECTION_NAME_ENUM.manual_entry_old
    } 
