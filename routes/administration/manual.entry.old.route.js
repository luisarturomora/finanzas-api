...
var manual_entry_old_controller_1 = require("../../controllers/administration/manual.entry.old.controller");
var ManualEntryOldRoute = /** @class */ (function (_super) {
    __extends(ManualEntryOldRoute, _super);
    function ManualEntryOldRoute(app) {
        var _this = this;
        var manualEntryController = new manual_entry_old_controller_1.ManualEntryOldController();
    ...
    return ManualEntryOldRoute;
}(base_router_1.BaseRoute));
exports.ManualEntryOldRoute = ManualEntryOldRoute;
//# sourceMappingURL=manual.entry.old.route.js.map